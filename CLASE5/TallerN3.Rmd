...
Este práctico busca que puedas **leer, entender y modificar código en R**.  
Trabajaremos con conceptos fundamentales que se usan en bioinformática:

El objetivo es familiarizarse con los conceptos básicos de R:
...
Para ejecutar este .Rmd es necesario descargar el archivo CLASE5/datos.csv del repositorio
** Este archivo (datos.csv) se debe guardar en la misma carpeta donde se encuentra el archivo TallerN3.Rmd **
